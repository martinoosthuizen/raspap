...
## Prerequisites
Start with a clean install of the [latest release of Raspberry Pi OS (32-bit) Lite](https://www.raspberrypi.org/software/operating-systems/). The Raspberry Pi OS desktop and 64-bit beta distros are unsupported.
